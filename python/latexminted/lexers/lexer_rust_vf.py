...
class RustVfLexer(RegexLexer):
    ...
    vf_ghost_keywords = (words(('assert', 'assume_correct',
        ...
        'type_pred_decl', 'type_pred_def', 'let', 'let_lft', 'on_unwind_ens'), suffix=r'\b'), Annot.Keyword)
    ...
    tokens = {
        ...
        'base': [
            ...
            (r'//!.*?\n', String.Doc),
            (r'///(\n|[^/].*?\n)', String.Doc),
            (r'//@', Annot, 'annotation_single'),
            (r'//(.*?)\n', Comment.Single),
            (r'/\*\|', Token.Escape.Block.Delimiter.Begin, 'esc_block'),
            (r'/\*\*(\n|[^/*])', String.Doc, 'doccomment'),
            (r'/\*!', String.Doc, 'doccomment'),
            (r'/\*@', Annot, 'annotation_multi'),
        ...
        'esc_block': [
            (r'[^\|\*/]+', Token.Escape.Block),
            (r'\|\*/', Token.Escape.Block.Delimiter.End, '#pop'),
            (r'[\|\*/]', Token.Escape.Block),
        ],
        'annotation_single': [
            (vf_ghost_keywords),
